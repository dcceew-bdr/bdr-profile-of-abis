...
|*https://schema.org/name[Name]* | BDR Data Release Model
...
|*https://www.w3.org/TR/skos-reference/#historyNote[Version History]*| *2.0* - 2023 Dec - First release (v2.0 to match ABIS)
