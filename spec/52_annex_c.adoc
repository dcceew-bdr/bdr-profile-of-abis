...
|*https://www.w3.org/TR/skos-reference/#definition[Definition]* | This model is for a _manifest_ - a listing of contents - of data submissions to the <<BDR, Biodiversity Data Repository>>
